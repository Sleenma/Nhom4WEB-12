...
@Query("SELECT kh FROM KhachHang kh WHERE kh.tenKH LIKE %:tenKH% AND kh.sdt LIKE %:sdt%")
List<KhachHang> timKhachHangTheoTenVaSDT(@Param("tenKH") String tenKH, @Param("sdt") String sdt);
